...
{
    public class ReplicationPad3dProcessor : BaseProcessor<ReplicationPad3d>
    {
        public override string OpType => "Pad";

        public override DataFlowNode Process(ReplicationPad3d module, TraceContext context)
        {
            var inputName = context.GetCurrentValue();
            var outputName = context.CreateTempName();

            var pads = new List<int>();
            if (module.padding != null && module.padding.Length >= 6)
            {
