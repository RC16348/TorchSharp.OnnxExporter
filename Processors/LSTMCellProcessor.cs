...
{
    public class LSTMCellProcessor : BaseProcessor<LSTMCell>
    {
        public override string OpType => "LSTM";

        public override DataFlowNode Process(LSTMCell module, TraceContext context)
        {
            var inputName = context.GetCurrentValue();
            var hiddenStateName = context.GetNextValue();
            var cellStateName = context.GetNextValue();
            ...
            var node = new DataFlowNode(OpType,
                new[] { inputName, weightIhName, weightHhName, biasIhName, biasHhName, hiddenStateName, cellStateName },
                new[] { outputName, hiddenStateName, cellStateName });
